...
<img class="ui medium left floated image" src="../images/JS1.png">

## What is JavaScript?

JavaScript is an awesome programming language. At a glance, JavaScript sounds similar to Java, an object-oriented programming language but after doing a series of [Free Code Camp](https://www.freecodecamp.com/) lessons on JavaScript, I quickly found out that it is the most useful programming language in the field of Software Development. Millions of apps and websites use JavaScript as the main language to perform hundreds of functions like sending data or validating a request.
